export enum ModulosEnum {
    PrediccionesEspecificas = "Predicciones Especificas",
    ObservacionConvencional = "Observacion Convencional",
    ValoresClimatologicos = "Valores Climatologicos",
    InformacionSatelite = "Informacion Satelite",
    MapasYGraficos = "Mapas Y Graficos",
    Maestro = "Maestro",
    ProductosClimatologicos = "Productos Climatologicos",
    PrediccionMaritima = "Prediccion Maritima",
    RedesEspeciales = "Redes Especiales",
    RedRayos = "Red-Rayos",
    IndicesIncendios = "Indices-Incendios",
    PrediccionesNormalizadasTexto = "Predicciones-normalizadas-texto",
    RedRadares = "Red Radares",
    Avisos = "Avisos",
    Antartida = "Antartida"
}
...
export const opcionesGrupo1: Options[] = [{
    value: 'opcion1',
    label: 'Opción 1',
    explication:
...
export const opcionesGrupo2: Options[] = [{
    value: 'opcion8',
    label: 'Opción 8',
    explication:
...
export const opcionesGrupo3: Options[] = [
    {
        value: 'opcion11',
        label: 'Opción 11',
        explication:
...
export const opcionesGrupo4: Options[] = [
    {
        value: 'opcion18',
        label: 'Opción 18',
        explication:
...
export const opcionesGrupo5: Options[] = [
    {
        value: 'opcion20',
        label: 'Opción 20',
        explication:
...
export const opcionesGrupo6: Options[] = [
    {
        value: 'opcion22',
        label: 'Opción 22',
        explication:
...
export const opcionesGrupo7: Options[] = [
    {
        value: 'opcion24',
        label: 'Opción 24',
        explication:
...
export const opcionesGrupo8: Options[] = [
    {
        value: 'opcion27',
        label: 'Opción 27',
        explication:
...
export const opcionesGrupo9: Options[] = [
    {
        value: 'opcion29',
        label: 'Opción 29',
        explication:
...
export const opcionesGrupo10: Options[] = [
    {
        value: 'opcion33',
        label: 'Opción 33',
        explication:
...
export const opcionesGrupo11: Options[] = [
    {
        value: 'opcion34',
        label: 'Opción 34',
        explication:
...
export const opcionesGrupo12: Options[] = [
    {
        value: 'opcion36',
        label: 'Opción 36',
        explication:
...
export const opcionesGrupo13: Options[] = [
    {
        value: 'opcion58',
        label: 'Opción 58',
        explication:
...
export const opcionesGrupo14: Options[] = [
    {
        value: 'opcion60',
        label: 'Opción 60',
        explication:
...
export const opcionesGrupo15: Options[] = [
    {
        value: 'opcion62',
        label: 'Opción 62',
        explication:
